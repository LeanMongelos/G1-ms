...
/**
 * Servicio `DetallePedidoService`: reglas de negocio, transacciones y orquestación de DetallePedido. Los controllers delegan aquí; no accede HTTP directamente.
 */
@Service
